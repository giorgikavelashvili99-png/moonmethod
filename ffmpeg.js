!function(e, t) {
    ...
    var e = {
        ...
        d: (t, s) => {
            for (var r in s)
                e.o(s, r) && !e.o(t, r) && Object.defineProperty(t, r, {
                    enumerable: !0,
                    get: s[r]
                })
        }
    ...
    ( () => {
        ...
        var s = e.g.document;
        if (!t && s && (s.currentScript && (t = s.currentScript.src),
        !t)) {
            var r = s.getElementsByTagName("script");
            if (r.length)
                for (var a = r.length - 1; a > -1 && !t; )
                    t = r[a--].src
        }
        if (!t)
    ...
    const r = ( () => {
      ...
      , a = (new Error("unknown message type"),
    ...
    class i {
        ...
        load = ({classWorkerURL: s, ...r}={}, {signal: a}={}) => (this.#e || (this.#e = s ? new Worker(new URL(s,"file:///home/jeromewu/ffmpeg.wasm/packages/ffmpeg/dist/esm/classes.js"),{
            type: "module"
        ...
        writeFile = (e, s, {signal: r}={}) => {
            const a = [];
            return s instanceof Uint8Array && a.push(s.buffer),
            this.#i({
                type: t.WRITE_FILE,
                data: {
                    path: e,
